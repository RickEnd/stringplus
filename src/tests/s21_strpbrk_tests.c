...
Suite *suite_strpbrk(void) {
  ...
  tc12 = tcase_create("case_strpbrk");
  tcase_add_test(tc12, strpbrk_1);
  tcase_add_test(tc12, strpbrk_2);
  tcase_add_test(tc12, strpbrk_3);
  tcase_add_test(tc12, strpbrk_4);
  tcase_add_test(tc12, strpbrk_5);
  tcase_add_test(tc12, strpbrk_6);
  tcase_add_test(tc12, strpbrk_7);
  tcase_add_test(tc12, strpbrk_8);
