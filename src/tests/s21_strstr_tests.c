...
Suite *suite_strstr(void) {
  ...
  tc14 = tcase_create("case_strstr");
  tcase_add_test(tc14, strstr_1);
  tcase_add_test(tc14, strstr_2);
  tcase_add_test(tc14, strstr_3);
  tcase_add_test(tc14, strstr_4);
  tcase_add_test(tc14, strstr_5);
  tcase_add_test(tc14, strstr_6);
  tcase_add_test(tc14, strstr_7);
  tcase_add_test(tc14, strstr_8);
  tcase_add_test(tc14, strstr_9);
  tcase_add_test(tc14, strstr_10);
  tcase_add_test(tc14, strstr_12);
  tcase_add_test(tc14, strstr_13);
  tcase_add_test(tc14, strstr_14);
  tcase_add_test(tc14, strstr_15);
  tcase_add_test(tc14, strstr_16);
  tcase_add_test(tc14, strstr_17);
  tcase_add_test(tc14, strstr_18);
  tcase_add_test(tc14, strstr_19);
  tcase_add_test(tc14, strstr_20);
  tcase_add_test(tc14, strstr_21);
